  ...
  create() {
    ...
    setEnemyPathTowardsPlayer(enemy) {
      ...
      enemyFireHomingMissile(enemy, enemyBullets) {
        ...
        const bullet = enemyBullets.create(enemy.x, enemy.y, 'laserRed');
        bullet.body.setSize(4, 16);
      ...
      enemyFireSpreadShot(enemy, enemyBullets) {
        for (let i = -1; i <= 1; i++) {
          const spreadBullet = enemyBullets.create(enemy.x + i * 10, enemy.y, 'laserGreen');
      ...
      enemyFireBlue(enemy, enemyBullets) {
        // Slow attack shot
        const slowBullet = enemyBullets.create(enemy.x, enemy.y, 'laserBlue'); 
